...
// Mirrors `accounting.models.BASE_CURRENCY` — every rate this app caches is
// expressed as "how many BASE_CURRENCY units one unit of this currency is
// worth" (BASE_CURRENCY itself always maps to 1).
