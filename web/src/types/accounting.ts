...
export type TransferRuleCreate = components['schemas']['TransferRuleCreate']
export type TransferRuleUpdate = components['schemas']['TransferRuleUpdate']
...
export type GoalAutomation = components['schemas']['GoalAutomation']
export type GoalAutomationCreate = components['schemas']['GoalAutomationCreate']
export type GoalAutomationUpdate = components['schemas']['GoalAutomationUpdate']
export type GoalAutomationDirection = GoalAutomation['direction']
export type GoalAutomationMode = NonNullable<GoalAutomation['mode']>
export type GoalAutomationFrequency = NonNullable<GoalAutomation['frequency']>
...
export type SimulatorScenarioCreate = components['schemas']['SimulatorScenarioCreate']
